...
$pdf->SetTitle('PROGRAMA ESPECÌFICO DE AUDITORIA');
...
<table cellspacing="0" cellpadding="1" border="1">
    ...
    <tr>
        <td><b>OBJETIVO DE LA AUDITORIA: </b></td>
        <td colspan="3">{$sObjetivo}</td>
    </tr>
    <tr>
        <td><b>ALCANCE DE LA AUDITORIA: </b></td>
        <td colspan="3">{$sAlcance}</td>
    </tr>
...
$pdf->Output('Reporta de planeacion', 'I');
