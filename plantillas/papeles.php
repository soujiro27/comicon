	...
	<head>
		...
		function asignarRiesgo(riesgo,activo){
			...
			if (activo==true){
				...
				var select = document.getElementById("txtRiesgo");
 	
					for(var i = 0; i < lstri.length; i++) {
					
						var sel = new Option(lstri[i],i)
							select.options.add(sel);
							//i++;
		...
		function decarga(valor){
					...
					$.ajax({
						...
						success: function(response){
							...
							if (obj.final==null){
								...
								var nombre = "CED"+obj.final;
								window.location.href= "/plantillas/"+nombre;				
			...
			function checkfile(sender) {
				var validExts = new Array(".xlsx", ".xls", ".pdf", ".doc");
			...
			function recuperarTipoPapeles(fase){
				...
				if (fase=="") {
					document.getElementById('txtTipoPapel').readOnly=true;					
				}else{
					document.getElementById("txtTipoPapel").readOnly=false;
				}						
			}
				...
				<div class="modal-body">
							<form id="formulario" METHOD='POST' ACTION="/guardar/pa" role="form">
								...
								<div class="form-group">											
									...
									<div class="col-xs-5">
										<select class="form-control" id="TipoPapel" name="txtTipoPapel" onfocus="validaFase(txtFase.value);" onchange="aparece();">
											<option value="">Seleccione...</option>
										</select>
									</div>
									<div class="col-xs-1">
											...
											<div class="panel-body"  style="height:300px; overflow: auto; overflow-x:hidden;">
												...
												<div id="divCptControles" style="display:none">
													...
													<div class="form-group">
														...
														<div class="col-xs-3">
															<select class="form-control" id="txtRiesgo" name="txtRiesgo" onclick="Riesgo();">
																<option value="">Seleccione...</option>
															</select>
														</div>										
