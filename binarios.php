...
<html lang="en">
	<head>	
		...
		<style type="text/css">		
  		...
  		<?php if (isset($_GET['proceso'])){ echo $_GET['proceso']."<br>"; } ?>
		...
		<script type="text/javascript"> 		
			...
			function checkfile(sender) {
				...
				if (validExts.indexOf(fileExt) < 0) {
				  alert("El archivo seleccionado es inválido. Los formatos correctos son " + validExts.toString() + ".");
				  return false;
				}
				else return true;
			}
			...
			function completeHandler(event){
				...
				if(event.target.responseText!="ERROR"){				
					...
					var rutaArchivoBinario = event.target.responseText;
					alert("Valor rutaArchivoBinario: " + rutaArchivoBinario);

					$.ajax({
						type: 'GET', url: '/guardarBinario/' + rutaArchivoBinario.replace("/","*") + '/' + sArchivoCarga,
						success: function(response) {
							alert(response);
							//var obj = JSON.parse(response);
					},
						error: function(xhr, textStatus, error){
							alert('function completeHandler()   -> statusText: ' + xhr.statusText + ' TextStatus: ' + textStatus + ' Error:' + error );
						}
					});		
		...
		<div class="container-fluid">
			<nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">			
				<div class="col-xs-12">
					...
					<div class="col-xs-3"><h2><i class="fa fa-tasks"></i>Binarios</h2></a></div>									
					<!--
					<div class="col-xs-2">
		...
		<div class="modal-dialog">							
			...
			<div class="modal-content">									
				<div class="modal-header">
					...
					<h3 class="modal-title"><i class="fa fa-pencil-square-o"></i> Archivos Binarios...</h3>
				</div>									
				<div class="modal-body">
					<form enctype="multipart/form-data" method="post" action="insertar.php" id="upload_form" role="form">
						...
						<input type="file" name="btnUpload" size="30" accept="application/pdf,application/vnd.ms-excel,,application/vnd.ms-word, " id="btnUpload">
