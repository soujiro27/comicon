...
<div class="col-md-12">
				  <div class="widget">
					<div class="widget-head">
					  <div class="pull-left"><h3 class="pull-left"><i class="fa fa-home"></i> Catálogo de Objetos de Auditoría</h3></div>
					  <div class="widget-icons pull-right">
						<button onclick="agregarDocumento();" type="button" class="btn btn-primary  btn-xs">Nuevo Objetos...</button> 						
					  </div>  
