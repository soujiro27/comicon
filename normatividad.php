  ...
  <meta charset="utf-8">
  	...
  	<style type="text/css">		
		@media screen and (min-width: 768px) {
			...
			#modalCaptura .modal-dialog  {width:50%;}
	...
	*****************************
	...
	<script type="text/javascript"> 
		...
		function validarCaptura(){
			...
			if (document.all.txtAcceso.selectedIndex==0)
            {
				alert("Debe Seleccionar el nivel de ACCESO de documento.");
				document.all.txtAcceso.focus();
				return false;
			}			
			
			if (document.all.txtNombre.value=="")
            {
				alert("Debe capturar el NOMBRE del documento..");
				document.all.txtNombre.focus();
				return false;
			}
			if (document.all.txtFechaInicial.value=="")
            {
				alert("Debe seleccionar la FECHA INICIAL de la vigencia.");
				document.all.txtFechaInicial.focus();
				return false;
			}
			if (document.all.txtFechaFinal.value=="")
            {
				alert("Debe Seleccionar la FECHA FINAL de la vigencia.");
            ...
            {
				alert("Debe seleccionar el ESTATUS del documento.");
				document.all.txtFechaFinal.focus();
				return false;
			}
			return true;
		...
		function limpiarCampos(){			
			...
			document.all.txtAcceso.selectedIndex=0;
		...
		{			
			$.ajax(
			{
				...
				success: function(response) {
					...
					seleccionarElemento(document.all.txtAcceso, obj.acceso);		
		...
		<div class="container-fluid">
			<nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">			
				<div class="col-xs-12">
					...
					<div class="col-xs-3"><h2>Normatividad Vigente</h2></a></div>									
					<div class="col-xs-2">
						...
						<div class="col-xs-12">
							<div class="widget">
								<div class="widget-head">
								  <div class="pull-left"><h3 class="modal-title"><i class="fa fa-tasks"></i> Normatividad Vigente</h3></div>
								  <div class="widget-icons pull-right">
								  	<button type="button" class="btn btn-primary  btn-xs" id="btnAgregar">Agregar Documento...</button> 	
								  	<!--
								...
								<div class="widget-content">
									<div class="table-responsive" style="height: 300px; overflow: auto; overflow-x:hidden;">
										<table class="table table-striped table-bordered table-hover table-condensed">
										  <thead>
											<tr><th>ID</th><th>Nombre</th><th>Tipo</th><th>Acceso</th><th>Vigencia</th><th>Estatus</th></tr>
										  </thead>
										  <tbody>				
											...
											<tr onclick=<?php echo "javascript:recuperaElemento('" . $valor['id'] . "');"; ?>
											  ...
											  <td><?php echo $valor['acceso']; ?></td>
											  <td><?php echo $valor['vigencia']; ?></td>
		...
		<div class="modal-dialog">							
			...
			<div class="modal-content">									
				<div class="modal-header">
					...
					<h3 class="modal-title"><i class="fa fa-pencil-square-o"></i> Registrar Normatividad...</h3>
				</div>									
				<div class="modal-body">
							<form id="formulario" METHOD='POST' ACTION="/guardar/normatividad" role="form">
								...
								<div class="form-group">						
									...
									<label class="col-xs-1 control-label">Acceso</label>
									<div class="col-xs-3">
								...
								<br>
								<div class="form-group">
									<label class="col-xs-2 control-label">Vigencia(s)</label>
									<div class="col-xs-5">
										<input type="date" class="form-control" name="txtFechaInicial" id="txtFechaInicial" placeholder="Fecha Inicio"/>
									</div>
									<div class="col-xs-5">
										<input type="date" class="form-control" name="txtFechaFinal"  id="txtFechaFinal" placeholder="Fecha Fin"/>
									</div>
								</div>						
				...
				<div class="modal-footer">
					...
					<div class="pull-right">
						<button  type="button" class="btn btn-default" id="btnCargaDocto"><i class="fa fa-link"></i> Anexar archivo...</button>
						<input type="file" name="btnUpload" accept="application/pdf" style="display:none;" id="btnUpload" value="">						
